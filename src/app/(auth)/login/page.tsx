    ...
    <div className="space-y-4">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground text-xs">
          Chọn phương thức xác thực để truy cập cây phả hệ
        </p>
      </div>
      ...
      <div className="relative my-3 flex items-center justify-center">
        ...
        <span className="bg-background text-muted-foreground absolute px-2 text-[11px] tracking-wider uppercase">
          hoặc
        </span>
      </div>
      ...
      <form action={formAction} className="space-y-4" noValidate>
        ...
        <Button type="submit" disabled={isPending} className="h-10 w-full font-medium">
          {isPending ? "Đang xử lý..." : "Đăng nhập với Email"}
        </Button>
