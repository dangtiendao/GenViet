...
import { Users, Heart, ArrowUpRight, ShieldCheck, HelpCircle } from "lucide-react";
    ...
    return (
      <div className="rounded-xl border border-dashed border-neutral-300 bg-neutral-50/70 p-6 text-center">
        ...
        <p className="mt-0.5 text-[11px] text-neutral-500">
          Nhân vật này chưa được liên kết với cha mẹ, con cái hoặc vợ chồng. Tính năng thiết lập
          quan hệ sẽ có trong Phase P13.
        </p>
      </div>
    );
  }
