export const TREE_GRAPH_ERROR_CODES = {
  ...
  TRAVERSAL_MODE_INVALID: "GRAPH_TRAVERSAL_MODE_INVALID",
  BRANCH_POLICY_INVALID: "GRAPH_BRANCH_POLICY_INVALID",
  BRANCH_BOUNDARY_INVALID: "GRAPH_BRANCH_BOUNDARY_INVALID",
  BRANCH_BOUNDARY_CROSS_TREE: "GRAPH_BRANCH_BOUNDARY_CROSS_TREE",
  DESCENDANT_METADATA_INVALID: "GRAPH_DESCENDANT_METADATA_INVALID",
...
export const TREE_GRAPH_ERROR_TAXONOMY: Record<TreeGraphErrorCode, TreeGraphErrorDetail> = {
  ...
  [TREE_GRAPH_ERROR_CODES.TRAVERSAL_MODE_INVALID]: {
    code: TREE_GRAPH_ERROR_CODES.TRAVERSAL_MODE_INVALID,
    message:
      "Chế độ duyệt hậu duệ không hợp lệ (chỉ chấp nhận PATERNAL_LINE hoặc ALL_DESCENDANTS).",
    httpStatus: 400,
  },
  [TREE_GRAPH_ERROR_CODES.BRANCH_POLICY_INVALID]: {
    code: TREE_GRAPH_ERROR_CODES.BRANCH_POLICY_INVALID,
    message: "Chính sách nhánh không hợp lệ.",
    httpStatus: 400,
  },
  [TREE_GRAPH_ERROR_CODES.BRANCH_BOUNDARY_INVALID]: {
    code: TREE_GRAPH_ERROR_CODES.BRANCH_BOUNDARY_INVALID,
    message: "Mã nhân vật biên nhánh không hợp lệ.",
    httpStatus: 400,
  },
  [TREE_GRAPH_ERROR_CODES.BRANCH_BOUNDARY_CROSS_TREE]: {
    code: TREE_GRAPH_ERROR_CODES.BRANCH_BOUNDARY_CROSS_TREE,
    message: "Nhân vật biên nhánh không thuộc cây gia phả hiện tại.",
    httpStatus: 403,
  },
  [TREE_GRAPH_ERROR_CODES.DESCENDANT_METADATA_INVALID]: {
    code: TREE_GRAPH_ERROR_CODES.DESCENDANT_METADATA_INVALID,
    message: "Metadata tính khả kiến của nhánh không hợp lệ.",
    httpStatus: 500,
  },
